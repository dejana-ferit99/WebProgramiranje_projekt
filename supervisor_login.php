...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, email, password, name, surname, supervisor FROM employee_data WHERE email = :email";
                    ...
                    if ($row = $stmt->fetch()) {
                        ...
                        if (password_verify($param_password, $hashed_password)) {
                            if ($supervisor == 1) {
                                ...
                                // Not a supervisor, redirect to employee login page
